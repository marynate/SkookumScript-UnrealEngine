...
// Modifiers:   virtual - overridden from SkClassDescBase
// Author(s):   Conan Reis
A_INLINE SkClassDescBase * SkContextClassBase::get_data_type(
  const ASymbol & data_name,
  eSkScope *      scope_p // = nullptr
  ) const
  {
  return m_class_p->get_data_type(data_name, scope_p);
  }
...
// Modifiers:   virtual - overridden from SkClassDescBase
// Author(s):   Conan Reis
A_INLINE SkMethodBase * SkContextClassBase::get_method(const ASymbol & method_name) const
  {
  return m_class_p->get_method(method_name);
  }
...
// Modifiers:   virtual - overridden from SkClassDescBase
// Author(s):   Conan Reis
A_INLINE SkMethodBase * SkContextClassBase::get_method_inherited(const ASymbol & method_name) const
  {
  return m_class_p->get_method_inherited(method_name);
  }
...
// Modifiers:   virtual - overridden from SkClassUnaryBase
// Author(s):   Conan Reis
A_INLINE void SkContextClassBase::append_method(SkMethodBase * method_p)
  {
  m_class_p->append_method(method_p);
  }
...
// Modifiers:   virtual - overridden from SkClassUnaryBase
// Author(s):   Conan Reis
A_INLINE void SkContextClassBase::append_coroutine(SkCoroutineBase * coroutine_p)
  {
  m_class_p->append_coroutine(coroutine_p);
  }
...
// Author(s):    Conan Reis
A_INLINE SkCoroutineBase * SkContextClassBase::get_coroutine_inherited(const ASymbol & coroutine_name) const
  {
  return m_class_p->get_coroutine_inherited(coroutine_name);
  }
...
A_INLINE bool SkContextClassBase::is_coroutine_valid(const ASymbol & coroutine_name) const
  {
  return m_class_p->is_method_valid(coroutine_name);
  }
