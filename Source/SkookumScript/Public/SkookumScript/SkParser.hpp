...
class SkParser : public AString
  ...
  // Methods
    ...
    // Class Result Type Methods
      ...
      SkLiteralList *    parse_literal_list(Args & args = ms_def_args.reset(), SkTypedClass * list_class_p = nullptr, bool item_type_b = false, SkMethodCall * ctor_p = nullptr) const;
  ...
  // Internal Methods
    ...
    // Internal Class Result Type Methods
      ...
      // entry and are set to resulting type on exit
        ...
        SkIdentifierMember * parse_data_accessor(Args & args, SkExpressionBase * owner_p) const;
        ...
        SkMethodCall *       parse_invoke_method(Args & args) const;
        SkMethodCall *       parse_invoke_method_arg1(Args & args, SkMethodBase * method_p, SkExpressionBase * arg1_p) const;
        SkMethodCall *       parse_invoke_ctor(Args & args) const;
        ...
        SkMethodCall *       parse_operator_call(Args & args) const;
        ...
        bool      parse_invoke_args(Args & args, APCompactArray<SkExpressionBase> * args_p = nullptr, APCompactArray<SkIdentifier> * ret_args_p = nullptr, const SkParameters * params_p = nullptr, eInvokeBrackets brackets = InvokeBrackets_opt_args0_closure, bool implicit_arg1_b = false) const;
        ...
        eResult   parse_invoke_return_args(uint32_t start_pos, uint32_t * end_pos_p, APCompactArray<SkIdentifier> * ret_args_p, const SkClassUnaryBase * receiver_type_p, const SkParameters * params_p, uint32_t bracket_flags) const;
